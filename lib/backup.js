...
export const BACKUP_FORMAT = 'prs-precision-backup';
...
export function readBackup(text) {
  ...
  if (parsed.format !== BACKUP_FORMAT) {
    return {
      ok: false,
      reason: 'That is not a PRS Precision backup. A session CSV is an export, not a backup — it carries no shots or scale.',
    };
  }

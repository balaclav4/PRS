 ...
 */
export function analyseSeating(depths, shotsPerGroup = 5) {
  ...
  return {
    ...
    verdict: significant
      ...
      : `${best.cbto}" shot smallest, but testing ${k} depths at ${shotsPerGroup} shots would produce a winner near ${expectedBestByChance.toFixed(2)} MOA by chance alone. This result is within that. Shoot ${Math.min(20, Math.max(8, shotsPerGroup * 2))}+ per depth, or treat the depths as equivalent and pick on feed and pressure.`,
  };
}
